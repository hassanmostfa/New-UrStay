       ...
       <!-- Mobile Menu  -->
        ...
        <div class="container">
            <div class="row justify-content-center" style="margin-top: 150px; margin-bottom: 50px;">
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header text-center bg-primary text-white" style="color: #e43c59;">تسجيل ضيف جديد</div>
                        <div class="card-body">
                            ...
                            <div id="user-section" style="display:none;"  dir="rtl">
                                <form enctype="multipart/form-data" action="{{ route('userRegisterSave')}}" method="POST" id="user-form">
                                    ...
                                    <p class="text-center mt-3">
                                        لديك حساب بالفعل؟ <a href="{{ route('user-login') }}" style="color: #e43c59;">سجل دخولك هنا</a>
                                    </p>
                                </form>
                            </div>
                        </div>
