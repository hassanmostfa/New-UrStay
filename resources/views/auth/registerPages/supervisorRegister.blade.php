...
<title>تسجيل مشرف عقاري جديد</title>
                ...
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div id="supervisor-section" style="display: none;"  dir="rtl">
                                <form class="container" enctype="multipart/form-data" action="{{ route('supervisorRegisterAction')}}" method="POST" id="supervisor-form">
                                    @csrf
                                    ...
                                    <p class="text-center mt-3">
                                        لديك حساب بالفعل؟ <a href="{{ route('supervisor.login') }}">سجل دخولك هنا</a>
                                    </p>
                                </form>
                            </div>
                        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" onclick="window.location.href='{{ route('supervisor.login') }}'">موافق</button>
                    </div>
                </div>
            </div>
        </div>
...
$(document).ready(function() {
    ...
    $('#supervisor-form').submit(function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "{{ route('supervisorRegisterAction') }}",
            data: formData,
            contentType: false,
            processData: false,
            success: function(response) {
