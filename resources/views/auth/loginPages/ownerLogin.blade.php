    ...
    <div class="boxed_wrapper">
        ...
        <div class="login-container">
            <div class="login-card">
                <h1 style="color: #e43c59;"> تسجيل دخول مالك </h1>
                <form method="post" action="{{ route('ownerLoginAction') }}">
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary w-100" style="background-color: #e43c59; border-color: #e43c59;">سجل الدخول</button>
                    </div>
                    <p>ليس لديك حساب حتي الان؟ <a href="{{ route('owner.register') }}" style="color: #e43c59;">انشأ حسابك</a></p>
                </form>
            </div>
        </div>
