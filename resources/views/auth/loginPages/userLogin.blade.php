    ...
    <div class="boxed_wrapper">
        ...
        <header class="main-header style-one">
                ...
                <div class="header-lower">
                    <div class="outer-box" style="display: flex; justify-content: space-between; align-items: center;">
                        ...
                        <div class="logo-box" style="order: 3;">
                            <figure class="logo"><a href="/"><img src="{{ asset('home-assets/images/new-logo.png') }}" alt=""></a></figure>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="sticky-header">
                <div class="auto-container">
                    <div class="header-lower">
                        <div class="outer-box" style=" height: 100px; display: flex; justify-content: space-between; align-items: center; top: 0px !important;">
                            <div class="menu-right-content" style="order: 1;">
                                <div class="btn-box"><a href="{{ route('userRegister')}}" class="theme-btn-one"><span class="btn-shape"></span>انضم الينا</a></div>
                            </div>
                            <div class="menu-area" style="order: 2;">
                            ...
                            <div class="logo-box" style="order: 3;">
                                <figure class="logo"><a href="/"><img src="{{ asset('user-assets/images/logo.png') }}" alt=""></a></figure>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="login-container">
            <div class="login-card">
                <h1 style="color: #e43c59;"> تسجيل دخول مستخدم </h1>
                <form method="post" action="{{ route('userLoginAction') }}">
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary w-100" style="background-color: #e43c59 !important; border-color: #e43c59 !important;">سجل الدخول</button>
                    </div>
                    <p>ليس لديك حساب حتي الان؟ <a href="{{ route('userRegister') }}" style="color: #e43c59;">انشأ حسابك</a></p>
                </form>
            </div>
        </div>
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-3 col-md-6 col-sm-12 footer-column">
                            <div class="footer-widget logo-widget">
                                <figure class="footer-logo"><a href="#"><img src="{{ asset('user-assets/images/footer-logo.png') }}" alt=""></a></figure>
