								...
								<div class="card-body">
									<div class="row">
												...
												<h2>
													...
													<strong>
														<select class="form-control" id="salesSelector">
															<option value="Porto Admin" selected>يورستاي 1</option>
															<option value="Porto Drupal" >يورستاي 2</option>
															<option value="Porto Wordpress" >يورستاي 3</option>
														</select>
													</strong>
												</h2>
										...
										<div class="col-xl-4 text-center">
											<h2 class="card-title mt-3">الاهداف المحققة</h2>
											<div class="liquid-meter-wrapper liquid-meter-sm mt-3">
												...
												<div class="liquid-meter-selector mt-4 pt-1" id="meterSalesSel">
													<a href="#" data-val="35" class="active m-0 p-0">الاهداف الشهرية</a>
													<a href="#" data-val="28">الاهداف السنوية</a>
												</div>
											</div>
										</div>
									</div>
										...
										<div class="card-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														<h4 class="title">الاستفسارات :</h4>
														<div class="info">
															<strong class="amount">1281</strong>
															<br/>
															<span class="text-primary">(14 غير مقروءة)</span>
														</div>
													</div>
													<div class="summary-footer">
														<a class="text-muted text-uppercase" href="#">(عرض الكل)</a>
													</div>
												</div>
									...
									<section class="card card-featured-left card-featured-secondary">
										<div class="card-body">
											<div class="widget-summary">
												<div class="widget-summary-col">
													<div class="summary">
														<h4 class="title">اجمالي الارباح</h4>
														<div class="info d-flex justify-content-centet align-items-center">
															<strong class="amount m-0">14,890</strong>
															<span>ر.س</span>
														</div>
													</div>
													<div class="summary-footer">
														<a class="text-muted text-uppercase" href="#">(سحب)</a>
													</div>
												</div>
									...
									<section class="card card-featured-left card-featured-tertiary mb-3">
										<div class="card-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														<h4 class="title">طلبات العملاء</h4>
														<div class="info">
									...
									<section class="card card-featured-left card-featured-quaternary">
										<div class="card-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														<h4 class="title">عدد الزيارات</h4>
														<div class="info">
															<strong class="amount">3765</strong>
														</div>
													</div>
													<div class="summary-footer">
														<a class="text-muted text-uppercase" href="#">(تقرير)</a>
													</div>
												</div>
						...
						<div class="col-lg-6 mb-4 mb-lg-0">
							<section class="card">
								<header class="card-header">
									...
									<h2 class="card-title">الاكثر مبيعا</h2>
									<p class="card-subtitle">خصص الرسوم البيانية كما تريد، هناك العديد من الخيارات والميزات لعرض المعلومات."</p>
								</header>
								<div class="card-body">
						...
						<div class="col-md-6">
							<section class="card mb-3">
								<header class="card-header">
									...
									<h2 class="card-title">المناطق</h2>
								</header>
								<div class="card-body">
						...
						<div class="col-xl-12">
							<section class="card">
								<header class="card-header card-header-transparent">
									...
									<h2 class="card-title">اخر العملاء</h2>
								</header>
								<div class="card-body">
