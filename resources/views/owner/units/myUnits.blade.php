...
<tr>
    ...
    <td>
        ...
        <span class="badge" style="background-color:#e43c59">يرجي استكمال البيانات</span>
    ...
    <td>
        @if ($unit->request_status == 'approved')
        <a href="{{ route('owner.unitDetails', $unit->id) }}" class="btn btn-secondary btn-sm">استكمال</a>
        @else
        <a href="{{ route('owner.unitDetails', $unit->id) }}" class="btn btn-secondary btn-sm">عرض</a>
        @endif

        <a href="{{ route('owner.updateUnit', $unit->id) }}" class="btn btn-success btn-sm" style="background-color:#e43c59">تعديل</a>
